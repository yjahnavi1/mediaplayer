package com.cg.mediaplyer.login;
...
import com.cg.mediaplayer.login.LoginModuleApplication;
...
import com.cg.mediaplayer.login.service.LoginServiceImpl;

@SpringBootTest
@ContextConfiguration(classes = LoginModuleApplication.class)
